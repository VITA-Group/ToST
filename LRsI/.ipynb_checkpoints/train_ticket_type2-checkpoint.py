...
def main():
    ...
    print('Before GradInit - Zero parameters: {}'.format(num_parameters))
    if args.gradinit:
        print("===========> Grad Init Initialization <===========")
        gradinit(model, trainloader, args)
    num_parameters = get_conv_zero_param(model)
    print('After GradInit - Zero parameters: {}'.format(num_parameters))
...
def train(trainloader, model, criterion, optimizer, epoch, use_cuda):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        loss = loss_label_smoothing(outputs, targets)
