...
for i in range(0, len(prune_ratio)):
    path1 = "../baseline_soft_activation/sparse_IMP_old/cifar100/"+ model + "/" +str(prune_ratio[i]) +"/log_scratch.txt"
    path2 = "./sparse_IMP/cifar100/"+ model + "/relu_mish/" +str(prune_ratio[i]) +"/log_scratch.txt"
    try:
